...
android {
    ...
    defaultConfig {
        ...
        applicationId = "com.muazramzii.password_manager"
    ...
    buildTypes {
        release {
            // Falls back to debug signing if key.properties isn't present (e.g. CI
            // checkout without the release keystore) so `flutter run --release`
            // still works; real release builds for the Play Store require
            // android/key.properties to point at the real keystore.
